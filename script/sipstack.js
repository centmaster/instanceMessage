...
(function (window) {
    ...
    (function (JsSIP) {
        ...
        Transport.prototype = {
            ...
            send: function (msg) {
                ...
                if (this.ws && this.ws.readyState === WebSocket.OPEN) {
                    if (this.ua.configuration.trace_sip === true) {
                        console.log(Date() + LOG_PREFIX + 'sending WebSocket message:\n\n' + message + '\n');
                    }
                    this.ws.send(message);
                    return true;
                } else {
                    console.warn(Date() + LOG_PREFIX + 'unable to send message, WebSocket is not open');
                    return false;
                }
            },
            ...
            disconnect: function () {
                if (this.ws) {
                    this.closed = true;
                    console.log(Date() + LOG_PREFIX + 'closing WebSocket ' + this.server.ws_uri);
                    this.ws.close();
                }
            },
            ...
            onClose: function (e) {
                ...
                if (connected_before === true) {
                    ...
                    //else {
                    //modified by chm 20150525 to throw the websocket error
            ...
            onMessage: function (e) {
                ...
                // WebSocket text message.
                    ...
                    if (this.ua.configuration.trace_sip === true) {
                        console.log(Date() + LOG_PREFIX + 'received WebSocket text message:\n\n' + data + '\n');
                    }
                }
                        ...
                        switch (message.method) {
                            ...
                            default:
                                ...
                                /*
                                 ...
                                 this.ua.updateTimer = window.setTimeout(this.ua.sessions[message.call_id + message.from_tag].sendUPDATE(), JsSIP.Timers.TIMER_N * 1000);
                                 }
                                 //END:GaoWei 20140529
                                 */
                                break;
    ...
    (function (JsSIP) {
        ...
        IncomingRequest.prototype.reply = function (code, reason, extraHeaders, body, onSuccess, onFailure) {
            ...
            ///zjz add
            response += 'Supported: ' + JsSIP.UA.C.SUPPORTED + '\r\n';
    ...
    (function (JsSIP) {
        var Transactions,
            ...
            C = {
                ...
                STATUS_TERMINATED: 6,
                STATUS_CONFIRMED: 7
                //STATUS_CONFIRMED:  7,//REPLACE:GaoWei 201405
                //STATUS_UPDATE:     8//ADD:GaoWei 201405
            };
            ...
            this.timer_reliableProvisional = function (retransmissions) {
                ...
                if (retransmissions > 8) {
                    ...
                    this.reliableProvisionalTimer = window.setTimeout(function () {
                        tr.timer_reliableProvisional(retransmissions);
                    }, timeout);
                }
            };
        ...
        Transactions.NonInviteServerTransaction = function (request, ua) {
            ...
            this.state = C.STATUS_TRYING;//REPLACE:GaoWei 201405
...
//ADD:GaoWei 201405
        Transactions.InviteServerTransaction = function (request, ua) {
            /*
             var reINVITE_dialog = ua.findDialog(request);
             */
            this.init(request, ua);
            this.state = C.STATUS_PROCEEDING;
            ...
            request.reply(100);//REPLACE:GaoWei 201405
        };
            ...
            checkInDialogRequest: function (request) {
                ...
                switch (request.method) {
                    ...
                    case JsSIP.C.INVITE:
                        ...
                        ///zjz
                        if (this.session && this.session.isMcu)
                            return true;
    ...
    (function (JsSIP) {
        ...
        Registrator.prototype = {
            ...
            unregister: function (options) {
                ...
                //window.clearTimeout(this.ua.updateTimer);//ADD:GaoWei 20140529
         ...
         */
            ...
            (function (JsSIP) {
                ...
                RTCMediaHandler.prototype = {
                    ...
                    createOffer: function (onSuccess, onFailure, offerOptions) {
                        var
                            self = this,
                            sent = false;
                        self.offerMediaOptions = offerOptions;

                        this.onIceCompleted = function () {
                            if (!sent) {
                                sent = true;
                                if (self.offerMediaOptions)
                                    onSuccess(self.mSdp);///修改后的SDP
                                else {
                                    //add by chm 20151217 to delete tcp info
                                    var message = self.peerConnection.localDescription.sdp;
                                    if (message.indexOf("tcp") !== -1) {
                                        message = message.replace(/a=candidate.*tcp.*\r\n/g, '');
                                        var audioLoc = message.length;
                                        message = message.replace(/Content-Length.*\r\n/, 'Content-Length= ' + audioLoc + '\r\n');
                                    }
                                    onSuccess(message);
                                }
                    ...
                    setLocalDescription: function (sessionDescription, onFailure) {
                        /// zjz Handle VP8 and VP9
                        var sdp = sessionDescription.sdp;
                        if (this.offerMediaOptions && this.offerMediaOptions.video.width && this.offerMediaOptions.video.height && sessionDescription.sdp.search("VP[89]") != -1) {
                            var max_fs = this.offerMediaOptions.video.width * this.offerMediaOptions.video.height / 256;
                            var re = /(a=rtpmap:(\d*) VP[89]\/90000\r\n)/;
                            sdp = sdp.replace(re, "$1" + "a=fmtp:" + "$2" + " max-fr=" + this.offerMediaOptions.video.framerate + "; max-fs=" + max_fs + "\r\n");
                            sessionDescription.sdp = sdp;
                            this.mSdp = sdp;
                        }
                        if (sdp.indexOf('UDP/TLS/RTP/SAVPF') !== -1) {
                            sdp = sdp.replace(/UDP\/TLS\/RTP\/SAVPF/g, "RTP/SAVPF");
                            sessionDescription.sdp = sdp;
                            this.mSdp = sdp;
                        }

                        //modified by chm 20150515 to adapt firefox
                        this.peerConnection.setLocalDescription(
                            sessionDescription,
                            function () {
                                console.log('Set localDscription success');
                            },
                            function (e) {
                    ...
                    //add by chm 20150501 to adapt the createAnswer
                    setRemoteDescription: function (sessionDescription, onFailure) {
                        this.peerConnection.setLocalDescription(
                            sessionDescription,
                            function () {
                            ...
                            function (e) {
                                console.error(LOG_PREFIX + 'unable to set remote description');
                                console.error(e);
                                onFailure();
                            }
                        );
                    ...
                    init: function (constraints) {
                        ...
                        for (idx in this.session.ua.configuration.stun_servers) {
                            ...
                            console.log(LOG_PREFIX + 'iceServers : ' + server.server);
                            break;//zzc
                        }
                        ...
                        //modified by chm 20150402
                        if (typeof mozRTCPeerConnection !== 'undefined') {
                            this.peerConnection = new JsSIP.WebRTC.RTCPeerConnection(servers, constraints);
                        } else {
                        ...
                        ///this.peerConnection = new JsSIP.WebRTC.RTCPeerConnection({'iceServers': servers});//added by all 20141209
                        ...
                        this.peerConnection.onicecandidate = function (e) {
                            ...
                            if (e.candidate) {
                                ...
                                if (timerGathering == null) {
                                    timerGathering = setTimeout(function () {
                                ...
                                self.onIceCompleted();
                                clearTimeout(timerGathering);
                            }
                        };

                        // To be deprecated as per https://code.google.com/p/webrtc/issues/detail?id=1393
                        this.peerConnection.onicegatheringstatechange = function () {
                            console.log(LOG_PREFIX + 'ICE gathering state changed to "' + this.iceGatheringState + '"');
                        };
                        ...
                        this.peerConnection.onconnectionstatechange = function () {
                            console.log(LOG_PREFIX + 'PeerConnection state changed to "' + this.connectionState + '"');
                        };
                    },
                    ...
                    close: function () {
                        ...
                        if (this.peerConnection) {
                            ...
                            /*
                             modified by chm 20151217 to close the localmedia*/
                            /*if(this.localMedia) {
                             console.log("chm prints %s",'stop' in this.localMedia);
                             if ('stop' in this.localMedia){
                             this.localMedia.stop();
                             }
                             }*/
                            if (this.localMedia && this.localMedia.active) {
                                if (this.localMedia.getAudioTracks().length > 0) {
                                    this.localMedia.getAudioTracks()[0].stop();
                                }
                                if (this.localMedia.getVideoTracks().length > 0) {
                                    this.localMedia.getVideoTracks()[0].stop();
                                }
                            }
                        }
                    },
                    ...
                    getUserMedia: function (onSuccess, onFailure, constraints) {
                        ...
                        //add by chm 20151221 to add screen share
                        if (constraints && constraints.screen) {
                            getScreenId(function (error, sourceId, screen_constraints) {
                                if (constraints.multi) {
                                    //screen_constraints.video.mandatory.maxWidth = 1280;
                                    //screen_constraints.video.mandatory.maxHeight = 720;
                                    screen_constraints.video.mandatory.maxWidth = constraints.video.mandatory.maxWidth;
                                    screen_constraints.video.mandatory.maxHeight = constraints.video.mandatory.maxHeight;
                                    delete constraints.multi;
                                }
                                JsSIP.WebRTC.getUserMedia(screen_constraints, function (stream) {
...
// Return since it will be assigned to a variable.
        ...
        RTCSession = function (ua) {
            var events = [
                ...
                'startRecordRemote',
                'endRecordRemote'
                //'notify'//add by lijiayuan//DELETE:GaoWei 20140530
            ];
            ...
            this.timers = {
                ...
                expiresTimer: null,
                invite2xxTimer: null,
                //userNoAnswerTimer: null//REPLACE:GaoWei 20140530
                //ADD:GaoWei 20140530
        ...
        RTCSession.prototype.terminate = function (options) {
            ...
            //added by chm 20150505
            if (options.unNormal && options.unNormal == true) {
                this.ua.unregister();
            }
        ...
        RTCSession.prototype.answer = function (options) {
            ...
            // rtcMediaHandler.addStream successfully added
                streamAdditionSucceeded = function () {
                    //modified by chm 20150430
                    if (self.isMcu) {
                        if (self.roomInfo.remoteMedia == "video" && mediaConstraints.video) {
                            self.rtcMediaHandler.createOffer(
                                answerCreationSucceeded,
                                answerCreationFailed,
                                //{"mandatory":{"OfferToReceiveAudio":true,"OfferToReceiveVideo":true}}
                                {"audio": {}, "video": {"width": 640, "height": 480, "framerate": 30}}
                            );
                        }
                        else {
                            self.rtcMediaHandler.createOffer(
            ...
            // rtcMediaHandler.createAnswer succeeded
                answerCreationSucceeded = function (body) {
                    ...
                    extraHeaders.push('Session-Expires:' + JsSIP.Timers.TIMER_N + ';refresher=uac');
         ...
         * @private
         */
        RTCSession.prototype.init_incoming = function (request, constraint) {
            var expires,
                self = this,
                contentType = request.getHeader('Content-Type');

            ///zjz
            if (request.headers["Alert-Info"] && request.headers["Alert-Info"][0].raw.indexOf('gvcname') != -1) {
                this.isMcu = true;
                this.roomInfo = {};
                var strInfo = request.headers['Alert-Info'][0].raw;
                var reg = /^.*gvctype=(.*);gvcid=(.*);gvcname=(.*)$/;
                var arrayInfo = reg.exec(strInfo);
                this.roomInfo.gvctype = arrayInfo[1];
                this.roomInfo.gvcid = arrayInfo[2];
                this.roomInfo.gvcname = arrayInfo[3];

                switch (this.roomInfo.gvctype) {
                    case '0':
                        this.roomInfo.gvctype_cn = '语音群聊';
                        break;
                    case '1':
                        this.roomInfo.gvctype_cn = '语音对讲';
                        break;
                    case '2':
                        this.roomInfo.gvctype_cn = '两方语音';
                        break;
                    case '9':
                        this.roomInfo.gvctype_cn = '语音直播';
                        break;
                    case '20':
                        this.roomInfo.gvctype_cn = '视频群聊';
                        break;
                    case '21':
                        this.roomInfo.gvctype_cn = '视频对讲';
                        break;
                    case '22':
                        this.roomInfo.gvctype_cn = '两方视频';
                        break;
                    case '29':
                        this.roomInfo.gvctype_cn = '视频直播';
                }

                if (this.roomInfo.gvctype.length == 2)
                    this.roomInfo.remoteMedia = "video";
                else
                    this.roomInfo.remoteMedia = "audio";
            ...
            if (this.isMcu) {
                ...
                this.rtcMediaHandler = new RTCMediaHandler(this, constraint);//add by gll 20140721
...
//console.log("options:"+options);  
            ...
            extraHeaders.push('Allow: ' + JsSIP.Utils.getAllowedMethods(this.ua));
            //add by chm 20150409
            extraHeaders.push('Call-Info: ' + options.extraParas);
            extraHeaders.push('Content-Type: application/sdp');
            //ADD:GaoWei 201405
            extraHeaders.push('Session-Expires: ' + JsSIP.Timers.TIMER_N);
            //END:GaoWei 201405
        ...
        RTCSession.prototype.close = function () {
            ...
            //add by chm 20150608 to adapt multiCall
            this.ua.curSession = null;
            ...
            if (request.method === JsSIP.C.CANCEL) {
                ...
                switch (request.method) {
                    ...
                    case JsSIP.C.INVITE:
                        ...
                        if (this.status === C.STATUS_CONFIRMED || this.isMcu) {
                            //ADD:GaoWei 20140529
                            //布置到公网之后需要恢复被注释的语句
                            ///zjz ADD
                            var extraHeaders = [];
                            extraHeaders.push('Session-Expires:' + JsSIP.Timers.TIMER_N + ';refresher=uac');
                            extraHeaders.push('Allow: ACK,CANCEL,BYE,OPTIONS,UPDATE,INVITE');
                            request.reply(200, null, extraHeaders, this.rtcMediaHandler.peerConnection.localDescription.sdp);
                            //END:GaoWei 20140529
                    ...
                    case JsSIP.C.UPDATE:
                        ...
                        extraHeaders.push('Session-Expires:' + JsSIP.Timers.TIMER_N + ';refresher=uac');
                        request.reply(200, null, extraHeaders);
                        window.clearTimeout(this.timers.updateTimer);
                        this.timers.updateTimer = window.setTimeout(function (rtcSession) {
                            cause = JsSIP.C.causes.UNAVAILABLE;
                            rtcSession.failed('remote', null, cause);
                        }, JsSIP.Timers.TIMER_N * 2 * 1000, this);
                        break;
                    //END:GaoWei 20140529
                    //add by lijiayuan@2013-7-17
                    case JsSIP.C.NOTIFY:
                        //var session = this;//DELETE:GaoWei 20140530
                        //this.emit("notify",session,{/*notify的内容*/});//DELETE:GaoWei 20140530
                        //ADD:GaoWei 20140530
                        if (request.body.indexOf("kickedBy") != -1) {
                            this.ua.unregister();
                            this.ua.emit("notifyKickby", this, {body: request.body});
                        } else if (request.body.indexOf("multiLogin") != -1) {
                            this.ua.emit("notifyMultiLogin", this, {body: request.body});
                        }
                        //END:GaoWei 20140530
                        break;
                    //end by lijiayuan@2013-7-17
                }
            }
        };
        ...
        RTCSession.prototype.sendInitialRequest = function (constraints) {
            ...
            // rtcMediaHandler.createOffer succeeded
                offerCreationSucceeded = function (offer) {
                    ...
                    offer = offer.replace(/sendrecv/g, constraints.direction);//zzc
        ...
        RTCSession.prototype.receiveResponse = function (response) {
            ...
            ///zjz add for update 500
            if (response.status_code == 500) {
                cause = JsSIP.C.causes.UNAVAILABLE;
                this.failed('remote', null, cause);
            }
            ...
            switch (true) {
                ...
                case /^1[0-9]{2}$/.test(response.status_code):
                    ...
                    break;
                case /^2[0-9]{2}$/.test(response.status_code):
                    //modified by chm 20150416:up the session_status
                    // Do nothing if this.dialog is already confirmed
                    if (this.dialog || session.status == C.STATUS_CONFIRMED) {
                        break;
                    }
                    //add by chm 20150416
                    ...
                    this.rtcMediaHandler.onMessage(
                        ...
                        function () {
                            ...
                            session.sendACK();
                            session.sendUPDATE();//ADD:GaoWei 201405
                            session.status = C.STATUS_CONFIRMED;
         ...
         * //ADD:GaoWei 201405
         */
        RTCSession.prototype.sendUPDATE = function () {
            var extraHeaders = [];
            extraHeaders.push('Session-Expires:' + JsSIP.Timers.TIMER_N + ';refresher=uas');
            var request = this.dialog.createRequest(JsSIP.C.UPDATE, extraHeaders);

            this.sendRequest(request);

            //ADD:GaoWei 20140530
            this.timers.updateTimer = window.setTimeout(function (rtcSession) {
                rtcSession.sendUPDATE();
            }, JsSIP.Timers.TIMER_N * 1000, this);
            //END:GaoWei 20140530
        };
        ...
        RTCSession.prototype.failed = function (originator, message, cause) {
            ...
            session.close();//zzc 先close导致未能通知上层failed事件，振铃不会停止、会话结束提示及原因界面无法提示等
        };
    ...
    (function (JsSIP) {
        ...
        UA = function (configuration) {
            ...
            //this.updateTimer = null;//ADD:GaoWei 201405
...
//=================
        ...
        UA.prototype.startRecordLocal = function (type) {
            var session = this.curSession;
            session.emit('startRecordLocal', session, {
                    type: type
                }
            );
        };

        UA.prototype.stopRecordLocal = function () {
            var session = this.curSession;
            session.emit('endRecordLocal', session, {
                    response: null
                }
            );
        };

        UA.prototype.startRecordRemote = function (type) {
            var session = this.curSession;
            session.emit('startRecordRemote', session, {
                    type: type
                }
            );
        };

        UA.prototype.stopRecordRemote = function () {
            var session = this.curSession;
            session.emit('endRecordRemote', session, {
                    response: null
                }
            );
        };
...
//add by chm 20150525
        UA.prototype.setSE = function (value) {
            JsSIP.Timers.TIMER_N = value;
        };
...
//=========================
        ...
        UA.prototype.receiveRequest = function (request) {
            ...
            if (method === JsSIP.C.OPTIONS) {
                ...
                //add by chm 20150525 to adapt message
                return;
            }
                ...
                switch (method) {
                    case JsSIP.C.INVITE:
                        if (JsSIP.WebRTC.isSupported) {
                            //add by chm 20150608 to refuse multiCall
                            if (this.curSession) {
                                request.reply(486);
                                return;
                            }
                            ...
                            //add by chm 20150601
                            this.curSession = session;
                            var constraint = {"optional": [{'DtlsSrtpKeyAgreement': 'false'}]};
                            session.init_incoming(request, constraint);
                            var sessionExpires = request.headers["Session-Expires"];
                            //modified by chm 20150525
                            var minSE = request.getHeader('Min-SE');
                            var seNum = parseInt(sessionExpires[0].raw);
                            if (JsSIP.Timers.TIMER_N > seNum)
                                JsSIP.Timers.TIMER_N = seNum;
                            else if (JsSIP.Timers.TIMER_N < parseInt(minSE))
                                JsSIP.Timers.TIMER_N = parseInt(minSE);
                        } else {
                    ...
                    case JsSIP.C.NOTIFY:
                        ...
                        if (request.body.indexOf("kickedBy") != -1) {
                            this.stop();
                            this.emit("notifyKickby", this, {body: request.body});
                        } else if (request.body.indexOf("multiLogin") != -1) {
                            //modified by chm 20150402
                            this.emit("notifyMultiLogin", this, {body: request.body});
                        }

                        if (request.body.indexOf("ChangedInfo") != -1) {
                            this.emit("notifyRoom", this, {body: request.body});
                        }
            ...
            // In-dialog request
                ...
                if (dialog) {
                    //console.log("receiveRequest4");
                    dialog.receiveRequest(request);
                } else if (method === JsSIP.C.NOTIFY) {
                    session = this.findSession(request);
                    if (session) {
                        //console.log(receiveRequest6);
                        session.receiveRequest(request);
                    } else {
        ...
        UA.prototype.loadConfig = function (configuration) {
            ...
            var parameter, value, checked_value, hostport_params, registrar_server,
                settings = {
                     ...
                     */
                    via_host: /*"1.1.1.1:8080",*/JsSIP.Utils.createRandomToken(12) + '.invalid',
                    ...
                    stun_servers: '',//[{server:"stun:10.109.247.86:3478", username: "test", credential:"1234"}],// ['stun:stun.l.google.com:19302'],
                    turn_servers: '',//[{server:"turn:10.109.247.86:3478", username: "test", credential:"1234"}],// [],
        ...
        UA.configuration_check = {
            ...
            optional: {
                ...
                stun_servers: function (stun_servers) {
                    ...
                    if (stun_servers instanceof Array) {
                        // Do nothing
                    } else {
                    ...
                    for (idx in stun_servers) {
                        ...
                        if (!stun_server.server || !stun_server.username || !stun_server.password) {
                            return;
                        } else if (!(/^stuns?:/.test(stun_server.server))) {
                            stun_server.server = 'stun:' + stun_server.server;
                        }

                        if (JsSIP.Grammar.parse(stun_server.server, 'stun_URI') === -1) {
                            return stun_servers;///zjz
                        } else if (JsSIP.Grammar.parse(stun_server.username, 'user') === -1) {
                            return stun_servers;///zjz
                        } else if (JsSIP.Grammar.parse(stun_server.password, 'password') === -1) {
                            return stun_servers;///zjz
                        }
                    }
                    return stun_servers;
